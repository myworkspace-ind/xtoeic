...
-- update ảnh và audio 2024 Test1 Part 1

update sam_publisheditemtext_t
set TEXT = '{"image": "resources/app-assets/images/questions/2024_test1_part1_1.png", "audio": "resources/app-assets/audios/2024_test1_part1_1.mp3"}'
where ITEMTEXTID = 2183;

update sam_publisheditemtext_t
set TEXT = '{"image": "resources/app-assets/images/questions/2024_test1_part1_2.png", "audio": "resources/app-assets/audios/2024_test1_part1_2.mp3"}'
...
update sam_publisheditemtext_t
set TEXT = '{"image": "resources/app-assets/images/questions/2024_test1_part1_4.png", "audio": "resources/app-assets/audios/2024_test1_part1_4.mp3"}'
...
update sam_publisheditemtext_t
set TEXT = '{"image": "https://xlms.myworkspace.vn/access/content/group/331180a0-0361-48d4-bc82-d120869731f9/TOEIC/2024/ETS_2024_N1/ETS_2024_N1/media/part1/1.png", "audio": "https://xlms.myworkspace.vn/access/content/group/331180a0-0361-48d4-bc82-d120869731f9/TOEIC/2024/ETS_2024_N1/ETS_2024_N1/media/part1/1.mp3"}'
where ITEMTEXTID = 2183;

update sam_publisheditemtext_t
set TEXT = '{"image": "https://xlms.myworkspace.vn/access/content/group/331180a0-0361-48d4-bc82-d120869731f9/TOEIC/2024/ETS_2024_N1/ETS_2024_N1/media/part1/2.png", "audio": "https://xlms.myworkspace.vn/access/content/group/331180a0-0361-48d4-bc82-d120869731f9/TOEIC/2024/ETS_2024_N1/ETS_2024_N1/media/part1/2.mp3"}'
where ITEMTEXTID = 2184;
